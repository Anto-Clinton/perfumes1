...
<head>
    ...
    <title>Register - Al-Madina</title>
...
<body>
    ...
    <div class="register-container">
        <h2>Join Al-Madina Today!</h2>
        <p class="subtext">Sign up and explore our exclusive collection of premium perfumes.</p>
        <form method="POST">
    ...
    <!-- Footer -->
    <footer>
        <p>&copy; 2025 Al-Madina - All Rights Reserved</p>
