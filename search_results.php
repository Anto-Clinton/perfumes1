...
<head>
  ...
  <title>Search Results - Al-Madina</title>
  ...
  <style>
    ...
    * {
    ...
    .hero-section {
      background: url('uploads/1.jpg') no-repeat center center/cover;
      padding: 120px 0;
      color: white;
      text-align: center;
      position: relative;
...
<body>
  ...
  <div class="hero-section">
    ...
    <p>Discover an exclusive collection of premium perfumes.</p>
  ...
  <!-- Footer Section -->
  <div class="footer">
    <p>&copy; 2025 Al-Madina. All rights reserved. <a href="privacy_policy.php">Privacy Policy</a></p>
  </div>
